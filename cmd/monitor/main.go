...
// Monitor is not an example program on its own, but an accompanying program
// that designed to poll the cluster and save the status to disk. The monitor
// program will exit if the status of the cluster can not be determined.
